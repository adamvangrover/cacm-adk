        ...
        try:
            ...
            result = {
                ...
                "related_topics": [
                    ...
                    and not topic.get(
                        "Topics"
                    )  # Only get main related topics, not sub-topics
                ],
...
if __name__ == "__main__":
    ...
    print(
        f"Testing module: {search_module.get_name()} - {search_module.get_description()}"
    )
    ...
    test_error_query = (
        "a query that might return less structured data or an empty abstract"
    )
