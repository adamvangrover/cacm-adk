...
class Validator:
    ...
    def validate_cacm_against_schema(
...
if __name__ == "__main__":
    ...
    if not validator.schema:
        ...
        print(
            f"Loaded schema: {validator.schema.get('title', 'Unknown Schema')}, Version: {validator.schema.get('description', 'N/A')}"
        )  # Adjusted to new schema structure
        ...
        print(
            f"Validation for 'valid_cacm_example': Is Valid = {is_valid}, Errors = {errors}"
        )
        ...
        is_valid, errors = validator.validate_cacm_against_schema(
            invalid_cacm_example_missing_name
        )
        print(
            f"Validation for 'invalid_cacm_example_missing_name': Is Valid = {is_valid}, Errors = {errors}"
        )
