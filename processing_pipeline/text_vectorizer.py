...
def get_filename_from_section_key(base_filename_parts: list, section_key: str) -> str:
    ...
    elif "FINANCIAL_STATEMENTS" in section_key: name_part = "FinancialStatements" # ITEM_8_FINANCIAL_STATEMENTS
    elif "BUSINESS" in section_key: name_part = "Business" # ITEM_1_BUSINESS
...
def vectorize_text_content(sectioned_data_path: str) -> dict:
    ...
    filename_parts = base_input_filename.replace("_sectioned.json", "").split('_') # MSFT, FY24Q4, 10K
    ...
    for section_key, section_text in sectioned_data.items():
        ...
        elif section_key == "__UNMATCHED_PREAMBLE__" or section_key == "UNKNOWN_CONTENT":
